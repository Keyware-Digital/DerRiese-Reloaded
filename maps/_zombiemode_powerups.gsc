...
//	add_zombie_powerup( "nuke", 		"zombie_bomb",		&"ZOMBIE_POWERUP_NUKE", 			"misc/fx_zombie_mini_nuke_hotness" );
	...
	add_zombie_powerup( "perk",		"zombie_3rd_perk_bottle_sleight",			&"Flak Jacket" );	//ZOMBIE_PERK_FLAK_JACKET 
	...
	while( 1 )
	{
		...
		for ( i = 0; i < players.size; i++ )
		{
			if( players[i] maps\_laststand::player_is_in_laststand() )
			{
				...
				players[i] maps\_zombiemode_perks::perk_hud_destroy( "specialty_detectexplosive" );
